  ...
  return (
    <View style={styles.container}>
      <View style={styles.insideContainer}>
        ...
        <TouchableOpacity style={[styles.button, styles.colorButton]} onPress={()=>handleOperatorInput('/')}>
          <Text style={[styles.buttonText, styles.colorText]}>÷</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={[styles.button, { width: 180 }]} onPress={()=>handleNumberInput(0)} >
          <Text style={styles.buttonText}>0</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, { width: 85 }, styles.colorButton]} onPress={()=>handleOperatorInput('+')}>
          <Text style={[styles.buttonText, styles.colorText]}>+</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, { width: 50 }, { backgroundColor: '#e8a405' }]} onPress={()=>handleEqual()}>
          <Text style={[styles.buttonText, { color: '#fff' }]}>=</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, { width: 320, height: 50 }, styles.colorButton]} onPress={()=>handleClear()} >
